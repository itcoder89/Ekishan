...
import com.android.ekishan.activity.CollectionDetailsSaleActivityNew;
...
public class CollectionsListAdapter extends RecyclerView.Adapter<CollectionsListAdapter.MyViewHolder> {
    ...
    public CollectionsListAdapter(Activity activity, List<VendorCollectionListData.DataBean> collection_list) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        try {
            ...
            Date dt = sdf.parse(collection_list.get(position).getCollection_date().getDate());
        ...
        holder.ll_view_single_post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                /*if(collection_list.get(position).getStatus().equalsIgnoreCase("demand")) {
                    ...
                    Intent intent=new Intent(activity, CollectionDetailsSaleActivityNew.class);//CollectionDetailsActivityNew ,CollectionDetailsActivity
                    intent.putExtra("order_id",collection_list.get(position).getId()+"");
                    intent.putExtra("status",collection_list.get(position).getStatus()+"");
                    activity.startActivity(intent);
                }*/
