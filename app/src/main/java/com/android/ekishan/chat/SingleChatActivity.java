...
public class SingleChatActivity extends AppCompatActivity {
    ...
    private void getAPIMessageList() {
        ...
        Call<APIChatModelData> responseCall = apiService.getMessage(MyApplication.getvendor_id(),"vendor");//login vendor id
        ...
        responseCall.enqueue(new Callback<APIChatModelData>() {
            ...
            public void onResponse(Call<APIChatModelData> call, Response<APIChatModelData> response) {
                ...
                for(int i=0;i<arrMessageList.size();i++){
                    ...
                    if(myid.equals(MyApplication.getvendor_id())){
                    //if(myid.equals("1")){
            ...
            public void onFailure(Call<APIChatModelData> call, Throwable t) {
                ...
                //Toast.makeText(SingleChatActivity.this, "Something Wrong...", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void sendAPIChatMessage(String msg) {
        ...
        Call<APISendMessageData> responseCall = apiService.sendMessage(MyApplication.getvendor_id(),msg,"vendor");//login vendor id
