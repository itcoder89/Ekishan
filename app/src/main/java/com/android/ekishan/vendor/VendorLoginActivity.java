            ...
            public void onClick(View v) {
                if (header.getText().toString().equalsIgnoreCase(getString(R.string.login))) {
                    if (edt_mobile.getText().toString().length() == 10) {
                        ...
                        Toast.makeText(VendorLoginActivity.this, "Please enter valid mobile", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    if (edtregmobile.getText().toString().length() == 10 && edtregmobile.toString().length() > 0) {
                        register(edtname.getText().toString(),edtaadhar.getText().toString(), edtemail.getText().toString(), edtregmobile.getText().toString());
                    }
                }
...
//                loginUserWithSocial(loginRequest);
                ...
                Toast.makeText(VendorLoginActivity.this, "Sorry unable to fetch details", Toast.LENGTH_SHORT).show();
                return;
            }
//            signOut();
...
//                        Toast.makeText(MainActivity.this, msg, Toast.LENGTH_SHORT).show();
    ...
    private void login(String mobile) {
        final ProgressDialog progressDialog = new ProgressDialog(VendorLoginActivity.this);
...
//        startActivity(new Intent(LoginActivity.this,CoursesActivity.class));
        Call<UpdateProfileResponse> responseCall = apiService.vendor_login(mobile,token);
        ...
        responseCall.enqueue(new Callback<UpdateProfileResponse>() {
            ...
            public void onResponse(Call<UpdateProfileResponse> call, Response<UpdateProfileResponse> response) {
                ...
                if (response.body().getSuccess().equals("1")) {
                    Intent intent = new Intent(VendorLoginActivity.this, VendorOtpActivity.class);
                    intent.putExtra("mobile", edt_mobile.getText().toString());
                    intent.putExtra("is_register", "0");
                    startActivity(intent);
                    finish();
                } else {
                    Toast.makeText(VendorLoginActivity.this, "" + response.body().getMessage(), Toast.LENGTH_SHORT).show();
...
//                }
            ...
            public void onFailure(Call<UpdateProfileResponse> call, Throwable t) {
                ...
                progressDialog.dismiss();
                Toast.makeText(VendorLoginActivity.this, "Something Wrong...", Toast.LENGTH_SHORT).show();
            }
        });
    }
...
//        startActivity(new Intent(LoginActivity.this,CoursesActivity.class));
        ...
        responseCall.enqueue(new Callback<VendorResponseRegister>() {
            ...
            public void onResponse(Call<VendorResponseRegister> call, Response<VendorResponseRegister> response) {
                ...
                if (response.body().getSuccess().equals("1")) {
                    Intent intent = new Intent(VendorLoginActivity.this, VendorOtpActivity.class);
                    intent.putExtra("mobile", edtregmobile.getText().toString());
