...
public class CollectionDetailsSaleActivityNew extends AppCompatActivity {
    ...
    private void getDetails() {
        final ProgressDialog progressDialog = new ProgressDialog(CollectionDetailsSaleActivityNew.this);
        ...
        responseCall.enqueue(new Callback<VendorTransactionDetailData>() {
            ...
            public void onResponse(Call<VendorTransactionDetailData> call, Response<VendorTransactionDetailData> response) {
                ...
                tvInvoiceNo.setText(response.body().getData().get(0).getOrders_id() + "");
                ...
                RecyclerView.LayoutManager mLayoutManager10 = new LinearLayoutManager(CollectionDetailsSaleActivityNew.this);
                recyclerview.setLayoutManager(mLayoutManager10);
                ProductsListAdapter productsListAdapter = new ProductsListAdapter(CollectionDetailsSaleActivityNew.this, collection_list);
...
//                }
            ...
            public void onFailure(Call<VendorTransactionDetailData> call, Throwable t) {
                ...
                progressDialog.dismiss();
                Toast.makeText(CollectionDetailsSaleActivityNew.this, "Something Wrong...", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
