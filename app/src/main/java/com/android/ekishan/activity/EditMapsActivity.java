...
public class EditMapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    //get lcation parram
    private static final String TAG = EditMapsActivity.class.getSimpleName();
    ...
    String address_id,lat,lng,firstname,lastname,mobile,postcode,city,street,house_no,google_location;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            google_location = extras.getString("google_location");
        }
        ...
        edt_house.setText(house_no);
        edt_complete_address.setText(google_location);
            ...
            public void onClick(View view) {
                ...
                if (!edt_pin.getText().toString().equalsIgnoreCase("")) {
                    if (!edt_complete_address.getText().toString().equalsIgnoreCase("")) {
                        if (isEdit) {
                            add_address(address_id, edt_name.getText().toString(), edt_name.getText().toString(), edt_mobile.getText().toString(), edt_street.getText().toString(),
...
//                Use only those fields which are required.
    ...
    private void add_address(String address_book_id, String f_name, String l_name, String mobile, String street, String pin, String city, String state, String complete_Add, double latitude, double longitude) {
        final ProgressDialog progressDialog = new ProgressDialog(EditMapsActivity.this);
        ...
        responseCall.enqueue(new Callback<UpdateProfileResponse>() {
            ...
            public void onResponse(Call<UpdateProfileResponse> call, Response<UpdateProfileResponse> response) {
                ...
                if (response.body().getSuccess().equals("1")) {
                    Toast.makeText(EditMapsActivity.this, "Address updated successfully", Toast.LENGTH_SHORT).show();
                    finish();
//                    getFragmentManager().popBackStack();
            ...
            public void onFailure(Call<UpdateProfileResponse> call, Throwable t) {
                ...
                progressDialog.dismiss();
                Toast.makeText(EditMapsActivity.this, "Something Wrong...", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        updateLat=Double.parseDouble(lat);
        updateLng=Double.parseDouble(lng);
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(EditMapsActivity.this,
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(EditMapsActivity.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(EditMapsActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                                mRequestingLocationUpdates = false;
                        }
